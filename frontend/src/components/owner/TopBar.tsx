          ...
          <div className="ml-auto flex items-center gap-2">
            ...
            <div className="relative">
              <button 
                ...
                className="w-9 h-9 flex items-center justify-center rounded-xl hover:bg-stone-100 text-stone-500 relative transition-colors"
              >
                <Bell size={20} />
              ...
              {notifOpen && (
                <div className="absolute right-0 top-12 bg-white border border-stone-200 rounded-2xl shadow-xl w-72 z-20 overflow-hidden">
                  ...
                  {notifications.map((n, i) => (
                    <div 
                      key={i} 
                      className={`flex items-start gap-3 px-4 py-3 hover:bg-stone-50 cursor-pointer ${i < 3 ? "bg-amber-50/40" : ""}`}
                    >
